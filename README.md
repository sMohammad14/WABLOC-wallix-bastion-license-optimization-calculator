...
## 🌟معرفی
 ...
 این برنامه به به عنوان یک ماشین حساب لایسنس، به شما خواهد گفت با تغییر نحوه تعریف Device ها در سامانه PAM، چه تعداد لایسنس صرفه جویی خواهد شد، بدون اینکه دسترسی اضافه ای برای کاربری ایجاد شود. 
...
1. In Wallix, from the left menu, go to **`Import/Export → CSV`**.
